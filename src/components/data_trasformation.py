...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        ...
        try:
            ...
            ## Joining categorical and numerical pipeline
    ...
    def intitiate_data_transformation(self, train_path,test_path):
        ...
        try:
            ...
            logging.info('Read trainand test data completed')
            ...
            logging.info('Applying preprocessing objecton traininig and testing datasets.')
            ...
            logging.info('Preprosessor pickle is created and saved')
